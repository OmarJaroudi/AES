...
class DecryptWindow(QWidget):
    ...
    def __init__(self, ciphertext, key):
        ...
        self.aes.Decrypt(self.ciphertext,key)
...
#        self.vboxkey.addLayout(self.hboxkey)
...
#        self.keyEXP = KeyWindow.KeyWindow(self.aes.keySteps, self.aes.keyOutput)
...
#            self.RoundOutputs.setText("Round Outputs: \n")
        if(self.counter < len(self.aes.decryptrounds)):
            self.aesRounds.setText("Round " + str(self.counter) + ": ")
...
#            self.keyOutput.setText("Word Output: \n")
...
#        self.keyEXP.success_signal.emit()
